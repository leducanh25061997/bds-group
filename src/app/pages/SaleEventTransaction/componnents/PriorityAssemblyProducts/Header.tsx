...
const keys: string[] = ['OPEN', 'BOOKING', 'WAIT_FILE', 'SOLD_OUT'];
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        onClick={() => handleRefresh('PHARSE_1')}
      >
        <Box>
          <img
            className={
              loadingHeader === 'PHARSE_1' || loadingHeader === 'PHARSE_ALL'
                ? 'spin'
                : ''
            }
            src={REFRESH_ICON}
        ...
        {handleCollapse && (
          <Box
            sx={{ marginLeft: '15px' }}
            onClick={() => handleCollapse('PHARSE_1')}
          >
